 ...
 * @returns {number}
 */
exports.word_count = function(text) {
 ...
 * @returns {number}
 */
exports.char_count = function(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {boolean}
 */
exports.is_wasm_supported = function() {
 ...
 * @returns {any}
 */
exports.get_memory_usage = function() {
    const ret = wasm.get_memory_usage();
    return ret;
};

const TextProcessorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
class TextProcessor {
    ...
    constructor() {
        const ret = wasm.textprocessor_new();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        TextProcessorFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} text
    ...
    analyze_text(text) {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.textprocessor_analyze_text(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     * @returns {any}
     */
    process_text(text, filter_profanity, normalize_whitespace) {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.textprocessor_process_text(this.__wbg_ptr, ptr0, len0, filter_profanity, normalize_whitespace);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    batch_process(texts) {
        const ret = wasm.textprocessor_batch_process(this.__wbg_ptr, texts);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    benchmark(text, iterations) {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.textprocessor_benchmark(this.__wbg_ptr, ptr0, len0, iterations);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
exports.__wbg_log_cb84ff5a2ea51bdb = function(arg0, arg1) {
...
const wasmPath = `${__dirname}/wasm_text_processor_bg.wasm`;
